...
@Component
class RestaurantModelAssembler implements RepresentationModelAssembler<Restaurant, EntityModel<Restaurant>> {
...
//    converting a non model object (Restaurant) into a model-based object(EntityModel<Restaurant>